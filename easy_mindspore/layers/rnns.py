...
from easy_mindspore.layers.rnn_cells import rnn_relu_cell, rnn_tanh_cell, lstm_cell, gru_cell
from mindspore.ops.primitive import constexpr
from easy_mindspore.operators import Reverse, ReverseSequence
